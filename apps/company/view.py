...
class CompanyDetail(DetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        work_dates = WorkDate.objects.filter(company=context.get('company'), date__range=[start_time, end_time])
        context['work_dates'] = work_dates

        work_times = WorkDate.objects.filter(company=context.get('company'))

        return context

# class CompanyDetail(FormView):
#     template_name = 'baraato/page2.html'
#     form_class = CompanyDateForm
#     success_url = '/'
